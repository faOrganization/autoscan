...
const Button = ({ data }) => {
  const { text, classNames, loadingText, type = 'button', clickHandler, isLoading = false } = data;
  return (
    <button type={type} onClick={clickHandler} disabled={isLoading}  className={'btn ' + classNames}>
      {isLoading ? <>
